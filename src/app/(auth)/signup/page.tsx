    ...
    return (
      <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md text-center">
          <div className="w-16 h-16 bg-[#d4a033]/20 rounded-full flex items-center justify-center mx-auto mb-6">
            <Mail className="w-8 h-8 text-[#d4a033]" />
          </div>
          ...
          <button
            ...
            className="px-6 py-3 bg-[#131a24] border border-[#2a3548] hover:border-[#3d4f6a] text-white font-medium rounded-lg transition-colors"
          >
    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#8899aa] text-sm">Join HytaleJoin and share your servers</p>
        </div>
        ...
        <div className="bg-[#131a24] border border-[#2a3548] rounded-xl p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6b7c93]" />
                <input
                  type="text"
            ...
            <div>
              ...
              <p className="text-xs text-[#6b7c93] mt-1">At least 8 characters</p>
            </div>
          ...
          {/* Terms */}
          <p className="mt-4 text-xs text-center text-[#6b7c93]">
            By signing up, you agree to our{' '}
            <Link href="/terms" className="text-[#d4a033] hover:underline">Terms of Service</Link>
            {' '}and{' '}
            <Link href="/privacy" className="text-[#d4a033] hover:underline">Privacy Policy</Link>
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-[#6b7c93]">
          ...
          <Link href="/login" className="text-[#d4a033] hover:text-[#e5b343] font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </div>
